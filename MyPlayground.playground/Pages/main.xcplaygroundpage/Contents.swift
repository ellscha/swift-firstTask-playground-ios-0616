...
var currentBankAcctBalance : Int
...
*/
// write your code here
currentBankAcctBalance = 1234567890

print("I have $\(currentBankAcctBalance) in my bank account.")
...
//Cannot because her name cannot be changed.
//: [Solution](solution)
